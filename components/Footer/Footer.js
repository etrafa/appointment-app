...
const Footer = () => {
  return (
    <footer className="bg-navbar text-center">
      <div className="pt-4">
      ...
      <div className="flex flex-col py-8">
        ...
        <span className="text-zinc-700">Careers</span>
        <span className="text-zinc-700">Contact Us</span>
      </div>
      <div className="flex flex-col py-8">
        <h2 className="text-2xl">Customers</h2>
        <span className="text-zinc-700">Patient</span>
        <span className="text-zinc-700">Doctor</span>
      </div>
      <div className="flex flex-col py-8">
      ...
      <div>
        ...
        <div className="flex justify-center py-6">
          <a href="https://facebook.com" target="_blank">
            <svg
              className="w-6 h-6 fill-slate-400 ml-4 hover:fill-black"
              role="img"
